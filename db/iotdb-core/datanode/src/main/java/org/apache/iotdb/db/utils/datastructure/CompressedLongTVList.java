...
public class CompressedLongTVList extends Series {
  ...
  public void persistent_compressing_sort() {
    CompressedDataSorter sorter =
        new CompressedDataSorter(this.timeCompressedData, this.valueCompressedData);
    sorter.blockSort(
        0, statistics.getCount2() - 1, 8, timeEncoder.getValsLen(), 8, valueEncoder.getValsLen());
  }
