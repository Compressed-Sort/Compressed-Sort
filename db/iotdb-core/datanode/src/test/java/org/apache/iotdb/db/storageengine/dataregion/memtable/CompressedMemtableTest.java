...
public class CompressedMemtableTest {
  ...
  @Test
  public void testWriteAndFlushTime()
      throws IOException, ExecutionException, InterruptedException, IllegalPathException {
    // 测试存储大小
    prepareData();
  ...
  public void prepareData() {
    ...
    // readCSV("D:/senior/毕设/画图/实验章节/内存压缩与不压缩的memtable/data/citibike_total.csv", times,  indexs,
    // values);
