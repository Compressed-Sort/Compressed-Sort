...
public class CompressedSeriesTest {
  ...
  public void testConvertAndSortTime() throws IOException {
    ...
    for (int j = 0; j < REAPEAT_NUM; j++) {
      CompressedLongTVList compressedTVList =
          new CompressedLongTVList(TSDataType.getTsDataType((byte) 2)); // 值域类型为long的tvlist
  ...
  public boolean readCSV(String filePath, int line_begin, int line_end, int col, List<Long> times) {
    // String filePath =
    // "D:/senior/DQ/research/data/node1/node1/data1/root.toyotads-3/_146629-119204515-0.csv";
  ...
  public boolean readCSVTime(
      String filePath, int line_begin, int line_end, int col, List<Long> times) {
    // String filePath =
    // "D:/senior/DQ/research/data/node1/node1/data1/root.toyotads-3/_146629-119204515-0.csv";
    BufferedReader reader = null;
  ...
  public void prepareData(List<Long> times, List<Long> values) {
    // 从指定的文件中加载数据集
    readCSV(
        "D:/senior/DQ/research/compressed_sort_paper/dataset/real/samsung/s-10_cleaned.csv",
        2,
        ROW_NUM + 1,
        0,
        times);
    ...
    readCSV(
        "D:/senior/DQ/research/compressed_sort_paper/dataset/artificial/exponential/exponential_1_1000.csv",
        2,
        ROW_NUM + 1,
        1,
        values);
