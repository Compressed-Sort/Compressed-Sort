...
public class EncodeDecodeTest {
  ...
  public void testDecodeTime() throws IOException {
    ...
    for (int j = 0; j < REAPEAT_NUM; j++) {
      ...
      timeBackwardDecoder1 =
          new TS_DELTA_decoder(
              timeDecoder1.getNowValue(), timeDecoder1.getNowNum(), timeDecoder1.getNowPos());
      long startTime = System.currentTimeMillis();
      for (int i = 0; i < ROW_NUM - 1; i++) {
  ...
  public void testTimeValueEncodeDecodeTime() throws IOException {
    ...
    // 将结果写入文件
    writeDataToTXT(
        new long[] {encodeTime1, encodeTime2, encodeTime3, decodeTime1, decodeTime2, decodeTime3});
  }
