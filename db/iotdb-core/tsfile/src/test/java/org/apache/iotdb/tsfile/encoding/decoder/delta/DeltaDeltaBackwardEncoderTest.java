...
public class DeltaDeltaBackwardEncoderTest {
  ...
  public void testCSV() throws IOException {
    ...
    readCSV(
        "D:\\senior\\SRT\\python_operator\\trans_data\\CS-Sensors\\test.csv",
        2,
        ROW_NUM + 1,
        1,
        times);
  ...
  public void prepareData(List<Long> times, List<Long> values) {
    ...
    // readCSV("D:\\senior\\毕设\\data\\201306-citibike-tripdata_digital_1000.csv", 1, ROW_NUM, 0,
    // times);
    readCSV(
        "D:\\senior\\DQ\\research\\new_encode\\data\\2013-citibike-tripdata\\2013-citibike-tripdata\\201306-citibike-tripdata.csv",
        2,
        ROW_NUM + 1,
        3,
        values);
